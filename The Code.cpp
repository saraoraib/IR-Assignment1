...
int main() {
    ...
    std::string newDocumentPath = "C:/Users/HP/OneDrive/Desktop/new_document.txt"; // Replace with the actual file path of the new document
    ...
    int documentIdToDelete = 2; // Replace with the actual document ID to delete
